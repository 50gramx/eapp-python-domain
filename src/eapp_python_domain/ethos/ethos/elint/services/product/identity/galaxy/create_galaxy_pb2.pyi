...
class CreateGalaxyRequest(_message.Message):
    __slots__ = ("galaxy_name", "universe", "domain", "galaxy_description")
    ...
    def __init__(self, galaxy_name: _Optional[str] = ..., universe: _Optional[_Union[_universe_pb2.Universe, _Mapping]] = ..., domain: _Optional[str] = ..., galaxy_description: _Optional[str] = ...) -> None: ...

class CreateGalaxyResponse(_message.Message):
    __slots__ = ("galaxy",)
