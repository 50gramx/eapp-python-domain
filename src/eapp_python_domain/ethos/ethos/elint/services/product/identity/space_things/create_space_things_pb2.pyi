...
class CreateThingsSpaceDomainRequest(_message.Message):
...
class CreateThingsSpaceDomainResponse(_message.Message):
    __slots__ = ("domain",)
...
class CreateNodesCollarRequest(_message.Message):
    __slots__ = ("collar",)
...
class CreateNodesCollarResponse(_message.Message):
    __slots__ = ("collar",)
    COLLAR_FIELD_NUMBER: _ClassVar[int]
    collar: _DC499999997_pb2.DC499999997
    def __init__(self, collar: _Optional[_Union[_DC499999997_pb2.DC499999997, _Mapping]] = ...) -> None: ...
