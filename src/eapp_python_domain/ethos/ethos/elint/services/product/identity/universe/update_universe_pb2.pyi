...
class UpdateUniverseRequest(_message.Message):
    __slots__ = ("universe_name", "universe_description", "universe_id")
    ...
    universe_id: str
    def __init__(self, universe_name: _Optional[str] = ..., universe_description: _Optional[str] = ..., universe_id: _Optional[str] = ...) -> None: ...

class UpdateUniverseResponse(_message.Message):
