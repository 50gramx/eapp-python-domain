...
class Universe(_message.Message):
    ...
    universe_id: str
    universe_name: str
    universe_created_at: _timestamp_pb2.Timestamp
    universe_description: str
    universe_updated_at: _timestamp_pb2.Timestamp
    def __init__(self, universe_id: _Optional[str] = ..., universe_name: _Optional[str] = ..., universe_created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., universe_description: _Optional[str] = ..., universe_updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
